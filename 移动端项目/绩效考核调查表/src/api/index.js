...
//文件
let httpbom = axios.create({
  baseURL: baseURL,
  withCredentials: false,
  headers: { 'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8' },
});
function apiAxiobom(method, url, params, response) {
...
export default {
  ...
  // 调用 this.$api.postJson
  bomJson: function (url,params,response) {
    return apiAxiobom('POST', url,params,response)
  },
  // 调用 this.$api.postJson
  bomget: function (url,params,response) {
    return apiAxiobom('GET', url,params,response)
  },
  // 调用 this.$api.get
