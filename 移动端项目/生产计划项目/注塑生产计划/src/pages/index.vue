  ...
  <div>
    ...
    <el-form ref="form" style="display:flex;justify-content: left;"  :model="form" >
        ...
        <el-form-item style="width:32%;">
          <el-button type="primary" v-if="btnSta==0" :disabled="xiugais!=1" @click="bianji">编辑</el-button>
          <el-button type="primary" v-if="btnSta==1"  @click="baocun">保存</el-button>
          <el-button type="primary" v-if="showSta==0" :disabled="shenhes!=1" @click="shenhe">审核</el-button>
          <el-button type="primary" v-if="showSta==1"  @click="baocuns">保存</el-button>
        </el-form-item>
