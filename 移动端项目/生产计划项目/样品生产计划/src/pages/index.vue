<template>
  <div>
    ...
    :header-cell-style="changeHeaderStyle" @header-click="click" style="width: 100%">
      ...
      <el-table-column prop="zhuangtai" :fixed="fixed['申请人']" :width="this.util.flexColumnWidth('zhuangtai',tableData)" label="申请人"> </el-table-column>
      <el-table-column prop="gongchengshi" :fixed="fixed['工程师']" :width="this.util.flexColumnWidth('gongchengshi',tableData)" label="工程师"> </el-table-column>
