...
const dateUtils = {
    ...
    getFormat(dates,nums){
        if(typeof(dates)=='string'){
            ...
            const addZeroMonth = addZero(dates.getMonth() + 1)
            const addZeroDate = addZero(dates.getDate()).toString()
            const addZeroHours = addZero(dates.getHours()).toString()
            const addZeroMinutes = addZero(dates.getMinutes()).toString()
            const addZeroSeconds = addZero(dates.getSeconds()).toString()
            if(nums==1){
